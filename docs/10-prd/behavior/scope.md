...
- an iPad-first sidebar-plus-content shell
- Goal Forest as an operable top-level orientation surface
...
- GUI remote desktop
- generic machine remote control through Codex Remote
- broad third-party integrations
- autonomous Goal Forest restructuring
- agent-operated workflows inside Goal Forest, Remote Control, or Codex Remote
...
- Does `0.1.0` need any manual review affordance beyond opening the relevant files through Remote Control?
